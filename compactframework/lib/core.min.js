...
!function(t){function e(){}e.prototype=function(){return this.__el="body",this.el="body",this.events={},this.handleBindEvent=function(){var e=this,n=[],i=this.$el;for(var r in this.events)if(this.events.hasOwnProperty(r)){var o=t.trim(r),a=this.events[r],s={},c="";if("string"==typeof a?(a=t.trim(a),this[a]&&"function"==typeof this[a]&&(s.handle=this[a])):"function"==typeof a&&(s.handle=a),s.handle)if(s.eventName=o.match(/\w+/)[0],o.length===s.eventName.length)s.delegate="",n.push(s);else{c=t.trim(o.substr(s.eventName.length));try{i.find(c).length>0;s.delegate=c,n.push(s)}catch(t){console.error("invalid event delegate binding : "+o+" : "+a)}}}i.off("."+this.mid),t.each(n,function(t,n){var r=[n.eventName+"."+e.mid];n.delegate&&r.push(n.delegate),r.push(function(){n.handle.apply(e,arguments)}),i.on.apply(i,r)})},this.__propertys__=function(){},this.initialize=function(){},this.showToast=function(t,e,n,i){},this.showConfirm=function(t,e,n,i){},this}.call({}),e.prototype.constructor=e;var n=function(){return this.View=function(n){var i=new e;t.extend(i,n||{});var r=this;return function(){this.$el=function(){var e=t(this.el);return e&&e.length||(e=t(this.__el)),e}.call(i),this.mid=r.getUniqueViewId(),this.handleBindEvent();var e=this;setTimeout(function(){e.__propertys__(),e.initialize()})}.call(i),i},this.convertCookieObject=function(e){var n={},i=(e||document.cookie).split(";"),r=function(e){return e?t.trim(decodeURIComponent(e)):""};try{for(var o=0,a=i.length;o<a;o++){var s=i[o],c=s.indexOf("="),u=r(s.substring(0,c)),h=r(s.substring(c+1));c>-1&&u&&(n[u]=h)}}catch(t){console.log("Cookie is Exception And expires")}return n},this.createDynamicScript=function(t,e,n,i){var r=document.createElement("script");if(r.setAttribute("type","text/javascript"),t)for(var o in t)t.hasOwnProperty(o)&&"src"!==o&&r.setAttribute(o,t[o]);r.onload=r.onreadystatechange=function(){this.readyState&&"loaded"!==this.readyState&&"complete"!==this.readyState||(r.onreadystatechange=r.onload=null,"function"==typeof n&&n.call(i||null,arguments))},r.src=e,document.body.appendChild(r)},this.uniqueArray=function(){var t=0;return function(e,n){for(var i=[],r=function(t,e,i){return"function"==typeof n?n(t,e,i):t===e},o=0,a=e.length;o<a;o++){for(var s=o+1;s<a;s++)console.log(++t),r(e[o],e[s],{preIndex:o,nextIndex:s,origin:e})&&(s=++o);i.push(e[o])}return i}}(),this.getUniqueViewId=function(){var t="view",e=0;return function(){return t+ ++e}}(),this.getParamsFromUrl=function(){return function(){var e={},n=location.search.substr(1);return n.replace(/([^?&]+)=([^?&]+)/g,function(n,i,r){return e[i]=t.trim(decodeURIComponent(r)),r+"="+t.trim(i)}),e}}(),this.generateUrlParam=function(e){var n="?";return _.each(e,function(e,i){var r=encodeURIComponent(t.trim(i))+"="+encodeURIComponent(t.trim(e));n+="?"!==n?"&"+r:r}),n},this}.call({});return t.extend({custom:n}),n}(jQuery);