...
!function(t){function e(){}e.prototype=function(){return this.__el="body",this.el="body",this.events={},this.handleBindEvent=function(){var e=this,n=[],i=this.$el;for(var r in this.events)if(this.events.hasOwnProperty(r)){var o=t.trim(r),a=this.events[r],c={},u="";if("string"==typeof a?(a=t.trim(a),this[a]&&"function"==typeof this[a]&&(c.handle=this[a])):"function"==typeof a&&(c.handle=a),c.handle)if(c.eventName=o.match(/\w+/)[0],o.length===c.eventName.length)c.delegate="",n.push(c);else{u=t.trim(o.substr(c.eventName.length));try{i.find(u).length>0;c.delegate=u,n.push(c)}catch(t){console.error("invalid event delegate binding : "+o+" : "+a)}}}i.off("."+this.__mid),t.each(n,function(t,n){var r=[n.eventName+"."+e.__mid];n.delegate&&r.push(n.delegate),r.push(function(){n.handle.apply(e,arguments)}),i.on.apply(i,r)})},this.__propertys__=function(){},this.initialize=function(){},this.destory=function(){this.$el.empty().off("."+this.__mid)},this}.call({}),e.prototype.constructor=e;var n=function(){var i=/([\\\/]*)[\w\.]+.js$/i;return this.convertCookieObject=function(e){var n={},i=(e||document.cookie).split(";"),r=function(e){return e?t.trim(decodeURIComponent(e)):""};try{for(var o=0,a=i.length;o<a;o++){var c=i[o],u=c.indexOf("="),l=r(c.substring(0,u)),s=r(c.substring(u+1));u>-1&&l&&(n[l]=s)}}catch(t){console.log("Cookie is Exception And expires")}return n},this.createDynamicScript=function(t,e,n,i){var r=document.createElement("script");if(r.setAttribute("type","text/javascript"),t)for(var o in t)t.hasOwnProperty(o)&&"src"!==o&&r.setAttribute(o,t[o]);r.onload=r.onreadystatechange=function(){this.readyState&&"loaded"!==this.readyState&&"complete"!==this.readyState||(r.onreadystatechange=r.onload=null,"function"==typeof n&&n.call(i||null,arguments))},r.src=e,document.body.appendChild(r)},this.uniqueArray=function(){return function(t,e){for(var n=[],i=function(t,n,i){return"function"==typeof e?e(t,n,i):t===n},r=0,o=t.length;r<o;r++){for(var a=r+1;a<o;a++)i(t[r],t[a],{preIndex:r,nextIndex:a,origin:t})&&(a=++r);n.push(t[r])}return n}}(),this.generateUniqueId=function(t){var e=0;return function(){return t+ ++e}},this.getTemplateByUrl=function(e,n,i,r){t.get(e).success(function(){"function"==typeof n&&n.apply(i,arguments)}).fail(function(t,e,n){console.log(t,e,n),"function"==typeof r&&r.apply(i,arguments)})},this.getTemplateSync=function(e,n,i,r){t.ajax({type:"get",url:e,async:!1}).success(function(){"function"==typeof n&&n.apply(i,arguments)}).fail(function(t,e,n){console.log(t,e,n),"function"==typeof r&&r.apply(i,arguments)})},this.getParamsFromUrl=function(){return function(){var e={},n=location.search.substr(1);return n.replace(/([^?&]+)=([^?&]+)/g,function(n,i,r){return e[i]=t.trim(decodeURIComponent(r)),r+"="+t.trim(i)}),e}}(),this.generateUrlParam=function(e){var n="?";return _.each(e,function(e,i){var r=encodeURIComponent(t.trim(i))+"="+encodeURIComponent(t.trim(e));n+="?"!==n?"&"+r:r}),n},this.getCurrentScript=function(){if(document.currentScript)return document.currentScript;for(var t=document.getElementsByTagName("script"),e=t.length-1;e>=0;e--){var n=t[e];if("interactive"===n.readyState){var i=n;return i}}return t[t.length-1]},this.getScriptRelativeUrl=function(e){var n=this.getCurrentScript(),r=t(n).attr("src");return r.replace(i,"$1"+e)},this.View=function(n){var i=n.generateUniqueId("__view_");return function(n){var r=new e;return t.extend(r,n||{}),function(){this.$el=function(){var e=t(this.el);return e&&e.length||(e=t(this.__el)),e}.call(r),this.__mid=i(),this.__propertys__();var e=this;setTimeout(function(){e.handleBindEvent(),e.initialize()})}.call(r),r}}(this),this.Component=function(r){var o=t(this.getCurrentScript()).attr("src"),a=this.generateUniqueId("__component_"),c={__compPath:o||location.href,data:null,templatePath:"",templateStr:""},u=function(t,e,r){if(!t.templateStr&&!t.templatePath)return console.log("参数不合法！"),!1;if(!t.templateStr&&t.templatePath){var o=t.__compPath.replace(i,"$1"+t.templatePath);n.getTemplateSync(o,function(t){"function"==typeof e&&e.apply(r,arguments)},this,function(){console.log("无效的template path！")})}else"function"==typeof e&&e.call(r,t.templateStr)};return function(n,i){var o=t.extend({},c,r||{},i),l=new e;return function(){if(this.$el=t(n),!this.$el||!this.$el.length)throw new Error("no available box element!");this.__mid=a();var e=this;u(o,function(n){t.extend(l,o,{templateStr:n});var i=t("<div>").attr("data-compid",e.__mid);e.data?i.html(_.template(n,o.data)):i.html(n),e.$el.html(i),e.__propertys__(),setTimeout(function(){e.handleBindEvent(),e.initialize()})},this)}.call(l),l}},this}.call({});return"object"!=typeof t.custom&&t.extend({custom:{}}),t.extend(t.custom,n),n}(jQuery);